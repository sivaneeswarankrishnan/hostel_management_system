...
public class DeleteRecord extends javax.swing.JFrame {
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        int input = JOptionPane.showConfirmDialog(null, "Press Yes if you want to delete this student.", "Confirmation",JOptionPane.YES_NO_OPTION);
        ...
        if(input==0)
        {
            ...
            try {
                Connection conn = DriverManager.getConnection("jdbc:derby://localhost:1527/HostelManagementSystem", "root", "1234");
                String sql = "DELETE FROM STUDENTS WHERE MATRIKSNO='" + matriksNo + "'";
                Statement st = conn.createStatement();
                st.executeUpdate(sql);
                st.close();
                conn.close();
                JOptionPane.showMessageDialog(f,"Student details has been deleted.");
                if(back==1)
                {
